      ...
      <form action="" class="form">
        ...
        <div id="botonesInternos">
          <div>
            ...
            <a href="php/eliminarSubCat.php" onclick="validacion_radio()" name="eliminarsubcat"><img class="boton" src="img/categorias/Eliminar subcategoria.jpg" alt="Eliminar subcategoria"></a>
          </div>
